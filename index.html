...
<body>
  ...
  <header class="navbar">
    ...
    <main class="container">
        ...
        <p class="descricao">Conecte-se com profissionais qualificadas e agende seu momento de autocuidado.</p>
        <div class="botoes">
            <a href="categoria.php" class="botao rosa">Cadastro</a>
            <a href="login.php" class="botao branco">Login</a>
        </div>
        </section>
    </main>
